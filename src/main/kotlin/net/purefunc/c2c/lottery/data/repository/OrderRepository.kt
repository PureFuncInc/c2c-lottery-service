...
interface OrderRepository {
    ...
    suspend fun findByUuid(uuid: String, email: String): Either<Throwable, OrderDtoRes>

    suspend fun findAll(email: String, page: Int, size: Int): Either<Throwable, List<OrderDtoRes>>
